...
def process_audio(audio_file, file_name, progress_placeholder):
    ...
    for i, start in enumerate(segments):
        ...
        chroma_short = librosa.feature.chroma_cqt(y=seg, sr=sr, tuning=tuning, n_chroma=12, n_fft=4096)
        chroma_long = librosa.feature.chroma_cqt(y=seg, sr=sr, tuning=tuning, n_chroma=12, n_fft=8192)
